...
const SitterDetails = ({ item }) => {
  ...
  return (
    <>
      <div className="container d-flex w-75 mt-5">
        <div className="col-3">
          <div className="d-flex  align-items-center justify-content-center flex-column">
            <img
              className="SitterDetails"
          ...
          <div className="d-flex w-100 align-items-center flex-row ms-3 justify-content-between">
            <div className="">
              <div className="mt-1  ms-2">
                <span className="fs-2 fw-bolder">Лука</span>
                <span className="fs-2 fw-bolder">Кенно</span>
              </div>
              <div className="d-flex flex-column">
                <div className=" ms-2">
                  {" "}
                  <GeoAltFill /> <span className="fs-5">Пловдив</span>
                </div>
                <div className="">
                  <StarPicker size={30} value={5} />
                </div>
              </div>
              <div className="SitterDetailsFontSizeDescription ">
                <div className="fs-6 ms-2">
                  добър гледач на кучета добър гледач на кучета добър гледач на
                  кучета
                </div>
              </div>
