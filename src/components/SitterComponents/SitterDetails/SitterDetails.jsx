          ...
          <div className="d-flex w-100 align-items-center flex-row ms-3 justify-content-between">
            <div className="">
              <div className="mt-1  ms-2">
                <span className="fs-2 fw-bolder">{item.name} </span>
                <span className="fs-2 fw-bolder">{item.surName}</span>
              </div>
              <div className="d-flex flex-column">
                <div className=" ms-2">
                  {" "}
                  <GeoAltFill /> <span className="fs-5">{item.city}</span>
                </div>
                <div className="">
                  <StarPicker
                    size={30}
              ...
              <div className="SitterDetailsFontSizeDescription ">
                <div className="fs-6 ms-2">{item.description}</div>
              </div>
