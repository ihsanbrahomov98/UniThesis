  ...
  return (
    <>
      <div className="d-flex flex-column">
        ...
        >
          <div className="d-flex justify-content-around position-absolute w-100 mt-3 pb-2 border-bottom border-start border-end NavbarBodyAliceblue">
