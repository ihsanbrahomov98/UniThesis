          ...
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block UserReviews">
              ...
              <p className="fw-bolder fs-5">
                ...
                път използвах нейните услуги и двамата с моето куче бяхме
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block UserReviews">
              ...
              <p className="fw-bolder fs-5">
                ...
                използвах неговите услуги и двамата с моето куче бяхме
                притеснени. Всички протече идеално и моето куче се върна удома
                щастливо. Благодаря ти {item && item.name ? item.name : "Ванка"}
                !
              </p>
            </div>
          </div>
