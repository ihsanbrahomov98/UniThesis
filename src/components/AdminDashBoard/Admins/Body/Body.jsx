...
import { ADMIN_URL } from "../../../../utils/Utils";
const Body = () => {
  ...
  const deleteProduct = (e) => {
    const deleteItem = async () => {
      await axios.delete(
        BACK_END_BASE_URL + ADMIN_URL + `/delete`,
        {
          data: {
            id: e.id,
          },
  ...
  const onSubmit = (e) => {
    const update = async () => {
      await axios.put(BACK_END_BASE_URL + ADMIN_URL + `/update`, {
        name: data.name,
        email: data.email,
        id: e,
      });
  ...
  const onSubmitCreate = (data) => {
    const create = async () => {
      await axios.post(BACK_END_BASE_URL + ADMIN_URL + `/create`, {
        name: data.name,
        email: data.email,
